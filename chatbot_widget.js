    ...
    const ChatWidget = {
        ...
        initializeChatLogic: function (client_id, client_secret, domain, container) {
            ...
            MRMessageIcon.innerHTML = `
                                <img 
                                    src="https://d2jcmbeljpidf8.cloudfront.net/bot-open-image.png" 
            ...
            MRCloseIcon.innerHTML = `
                                <img 
                                    src="https://d2jcmbeljpidf8.cloudfront.net/bot-close-image.png" 
                                    style="width: 60px; height: 60px;" 
                                    alt="Message Icon"
                                />
                                `;
